...
object MilestoneNotificationHelper {

    private const val CHANNEL_ID = "ayik_milestones"
    ...
    fun showMilestoneNotification(
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentTitle("$milestoneEmoji $milestoneLabel!")
            .setContentText("$habitName — You've reached a new milestone!")
